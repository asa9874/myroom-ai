...
class Model3DParametersPanel(BaseSettingsPanel):
    ...
    PRESETS = {
        "low": {
            "generation_defaults.ss_guidance_strength": 6.5,
            "generation_defaults.ss_sampling_steps": 12,
            "generation_defaults.slat_guidance_strength": 6.5,
            "generation_defaults.slat_sampling_steps": 12,
            "generation_defaults.mesh_simplify_ratio": 0.75,
            "generation_defaults.texture_size": 256,
        },
        "normal": {
            "generation_defaults.ss_guidance_strength": 7.5,
            "generation_defaults.ss_sampling_steps": 20,
            "generation_defaults.slat_guidance_strength": 7.5,
            "generation_defaults.slat_sampling_steps": 20,
        ...
        "high": {
            ...
            "generation_defaults.ss_sampling_steps": 30,
            "generation_defaults.slat_guidance_strength": 8.0,
            "generation_defaults.slat_sampling_steps": 30,
            "generation_defaults.mesh_simplify_ratio": 0.9,
    ...
    def _build_ui(self) -> None:
        ...
        title = ttk.Label(self, text="3D 모델 생성 파라미터", font=("맑은 고딕", 11, "bold"))
        ...
        for section_title, fields in sections:
            section = ttk.Label(self, text=section_title, font=("맑은 고딕", 10, "bold"))
        ...
        preset_frame = ttk.LabelFrame(self, text="프리셋")
